...
public class DateUtil {
    ...
    public static BigDecimal countHour(Date startDate,Date endDate,Integer scalse){
        if(com.server.hostel.util.PowerUtil.isNull( startDate ) || com.server.hostel.util.PowerUtil.isNull( endDate ) ){
            return BigDecimal.ZERO;
        }
        long diff = 0;
        try {
    ...
    public static String toWeek(Date date ,String[] weeks){
        ...
        return com.server.hostel.util.PowerUtil.getString(weeks[week_index]);
    }
    ...
    public static Date toDate(String str,String format){
        if("".equals( com.server.hostel.util.PowerUtil.getString(str))){
            return null;
        }
