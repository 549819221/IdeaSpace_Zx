package com.example.fastdfsdel.entity;
...
public class ExpressInfo {
    /*** 寄件人信息 */
    private com.example.fastdfsdel.entity.Sender sender;
    /*** 收件人信息 */
    private com.example.fastdfsdel.entity.Receiver receiver;
    /*** 快递员信息 */
    private com.example.fastdfsdel.entity.ExpressStaff expressStaff;
    /*** 1.寄件；2.派件 */
    private int type;
    /*** 1.散件；2.协议件 */
    ...
    public com.example.fastdfsdel.entity.Sender getSender() {
        return sender;
    }
    ...
    public com.example.fastdfsdel.entity.Receiver getReceiver() {
        return receiver;
    }
    ...
    public com.example.fastdfsdel.entity.ExpressStaff getExpressStaff() {
        return expressStaff;
    }
