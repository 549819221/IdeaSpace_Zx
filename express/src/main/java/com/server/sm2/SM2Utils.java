...
public class SM2Utils {
    ...
    public static Pair<String, String> generateKeyPair(){
        ...
        Pair<String, String> keyPair = new Pair<>( Util.byteToHex(publicKey.getEncoded()),Util.byteToHex(privateKey.toByteArray()) );
